...
int main() {
    ...
    while (flag == 1 && fgets(text[lines], MAXLEN_S, f)) {
        ...
        if (cnt_words_now == cnt_words_bef) {  // ≈сли в строке не было кл. слов, то минимальное слово обнул€ем
